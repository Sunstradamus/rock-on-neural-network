...
model.compile(optimizer=SGD(lr=0.01, decay=1e-5, momentum=0.8, nesterov=True), loss='categorical_crossentropy', metrics=['accuracy'])
...
model.save_weights('network8.h5')  # always save your weights after training or during training
